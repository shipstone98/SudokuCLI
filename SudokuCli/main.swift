...
fileprivate func solve(using strategies: [SudokuSolverStrategy]? = nil) {
    ...
    // Hidden pair (row): 000060000000042736006730040094000068000096407607050923100000085060080271005010094
    // Hidden pair (column): 000006100000900060006407005007000000643095081020060000070049020034602879060873514
